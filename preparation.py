...
while True:
    ...
    if project == 1:
        ...
        # os.system('cp ./A3C/api_server.py ./Deployment/a3c-eve')
        ...
        # os.system('python3 -m py_compile Deployment/a3c-eve/api_server.py')
        ...
        os.system('python3 -m py_compile Deployment/a3c-eve/envs/eve/api_server.py')
        ...
        # os.system('sudo rm ./Deployment/a3c-eve/api_server.py')
        ...
        os.system('sudo rm ./Deployment/a3c-eve/envs/eve/api_server.py')
